...
public final class OverLAPP {
    ...
    public static void main(String[] args) {
         ...
         * about controller
         */
        OvLModel model = new OvLModel1();
        OvLView view = new OvLView1();
        OvLController controller = new OvLController1(model, view);

        view.registerObserver(controller);

//        OvLGUI run = new OvLGUI();
